...
from guidance.attn_utils.transformer_2d import BasicTransformerBlock
...
class TransformerTemporalModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if not return_dict:
            return (output,)
        ###
        # print(f'in TransformerTemporalModel add multiple returns attn_weight_list {len(attn_weight_list)} cross_attn_weight_list {len(cross_attn_weight_list)}')
        return TransformerTemporalModelOutput(sample=output), attn_weight_list, cross_attn_weight_list