...
class Attention(nn.Module):
    ...
    def set_processor(self, processor: "AttnProcessor"):
        ...
        # print(f"in Attention set_processor the self.processor is {type(processor)} ")
    ...
    def get_attention_scores(self, query, key, attention_mask=None):
        ...
        print(f'in Attention attention_probs: {attention_probs.shape}')
...
class AttnProcessor:
    ...
    def __call__(
        ...
        print(f"in AttnProcessor attention_probs: {attention_probs.shape}")
...
class LoRAAttnProcessor(nn.Module):
    ...
    def __call__(
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask)
        print(f'in LoRAAttnProcessor attention_probs: {attention_probs.shape}')
...
class CustomDiffusionAttnProcessor(nn.Module):
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None):
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask)
        print(f'in CustomDiffusionAttnProcessor attention_probs: {attention_probs.shape}')
        hidden_states = torch.bmm(attention_probs, value)
        hidden_states = attn.batch_to_head_dim(hidden_states)
...
class AttnAddedKVProcessor:
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None):
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask)
        print(f'in AttnAddedKVProcessor attention_probs: {attention_probs.shape}')
...
class LoRAAttnAddedKVProcessor(nn.Module):
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None, scale=1.0):
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask)
        print(f'in LoRAAttnAddedKVProcessor attention_probs: {attention_probs.shape}')
        hidden_states = torch.bmm(attention_probs, value)
        hidden_states = attn.batch_to_head_dim(hidden_states)
...
class AttnProcessor2_0:
    ...
    def __call__(
        ...
        # print(f'in AttnProcessor2_0 attention_probs: {attn_weight.shape}')
...
class SlicedAttnProcessor:
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None):
        ...
        for i in range(batch_size_attention // self.slice_size):
            ...
            print(f'in SlicedAttnProcessor attn_slice: {attn_slice.shape}')
