...
class DDIMSampler(object):
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            print(f'in p_sample_ddim kwargs {kwargs.keys()} {kwargs["temporal_length"]}')
            ...
            print(f'in p_sample_ddim uc_type {uc_type}')
            # text cfg
            if uc_type is None:
                ...
                if uc_type == 'cfg_original':
                    ...
                    raise NotImplementedError
            # temporal guidance
            print(f'in p_sample_ddim conditional_guidance_scale_temporal {conditional_guidance_scale_temporal}')
